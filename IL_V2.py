# -*- coding: utf-8 -*-
"""
Created on Sun Feb  9 16:13:14 2025
...
m_mp.setParam('TimeLimit',7200) 

ini_time_OIL = time.time()
m_mp.optimize(callback)
timeOIL = time.time()-ini_time_OIL        # Optimization time
timeIL = time.time()-ini_time_IL          # Optimization + setup of models

#%% Results
print('Opt+Setup Time IL_V2', timeIL)
print('Optimization Time IL_V2', timeOIL)    
...
with open("gurobi_statistics_ILV2.txt", "w") as file:
    file.write("Scenarios, Method, Nodes Explored, Opt Time, Opt+Setup Time, Optimality Gap, Master Obj, Fixed Costs, 2-Stage OF, r\n")
    file.write(f"{N}, ILV2, {nodes_explored}, {timeOIL}, {timeIL}, {gap}, {OF}, {Fixed_costs}, {Second_Stage_OF}, {r}\n")
