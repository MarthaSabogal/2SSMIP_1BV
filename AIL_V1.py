# -*- coding: utf-8 -*-
"""
Created on Fri Nov 22 11:00:33 2024
...
#%% Results
print('Opt+Setup Time AIL_V1', timeAIL)
print('Optimization Time AIL_V1', timeOAIL)    
...
with open("gurobi_statistics_AILV1.txt", "w") as file:
    file.write("Scenarios,Method,Nodes Explored,Opt Time,Opt+Setup Time,Optimality Gap,Master Obj,Fixed Costs,2-Stage OF,r\n")
    file.write(f"{N},AILV1,{nodes_explored},{timeOAIL},{timeAIL},{gap},{OF},{Fixed_costs},{Second_Stage_OF},{r}\n")
