# -*- coding: utf-8 -*-
"""
Created on Mon Dec  9 10:54:34 2024
...
# to calculate the slack of added cuts (to identify the tight cut)
...
#%% Algorithm
final_alpha, final_beta, subp_obj, theta_scenarioval = {}, {}, {}, {}
...
ini_time_ODC = time.time()
m_mp.optimize(callback)
timeODC = time.time()-ini_time_ODC        # Optimization time
timeDC = time.time()-ini_time_DC          # Optimization + setup of models

#%% Results
print('Opt+Setup Time DC', timeDC)
print('Optimization Time DC', timeODC)    
...
with open("gurobi_statistics_DC.txt", "w") as file:
    file.write("Scenarios,Method,Nodes Explored,Opt Time,Opt+Setup Time,Optimality Gap,Master Obj,Fixed Costs,2-Stage OF,r\n")
    file.write(f"{N},DC,{nodes_explored},{timeODC},{timeDC},{gap},{OF},{Fixed_costs},{Second_Stage_OF},{r}\n")
