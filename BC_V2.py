# -*- coding: utf-8 -*-
"""
Created on Tue Feb 18 11:33:17 2025
...
with open("gurobi_statistics_BCV1.txt", "w") as file:
    file.write("Scenarios,Method,Nodes Explored,Opt Time,Opt+Setup Time,Optimality Gap,Master Obj,Fixed Costs,2-Stage OF\n")
    file.write(f"{N},BCV2,{nodes_explored},{timeOBC},{timeBC},{gap},{OF},{Fixed_costs},{Second_Stage_OF}\n")
