# -*- coding: utf-8 -*-
"""
Created on Sun Feb  9 15:52:38 2025
...
z = m_subp.addVar(vtype=GRB.BINARY)
...
#%% Results
print('Opt+Setup Time IL_V1', timeIL)
print('Optimization Time IL_V1', timeOIL)    
...
with open("gurobi_statistics_ILV1.txt", "w") as file:
    file.write("Scenarios,Method,Nodes Explored,Opt Time,Opt+Setup Time,Optimality Gap,Master Obj,Fixed Costs,2-Stage OF,r\n")
    file.write(f"{N},ILV1,{nodes_explored},{timeOIL},{timeIL},{gap},{OF},{Fixed_costs},{Second_Stage_OF},{r}\n")
