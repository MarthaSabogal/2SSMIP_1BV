...
filename = f"gurobi_stats_ABCV1_M_C_II_{se}_{int(r*100)}.txt"
print(filename)
...
#%% Results
print('Opt+Setup Time ABC_V1_M', timeABC)
print('Optimization Time ABC_V1_M', timeOABC)
...
with open(filename, "w") as file:
    ...
    file.write(f"{N},ABCV1_M_C_II,{nodes_explored},{timeOABC},{timeABC},{gap},{OF},{Fixed_costs},{Second_Stage_OF},{r},{se},{m_mp.status}\n")
