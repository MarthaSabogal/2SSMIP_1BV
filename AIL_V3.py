# -*- coding: utf-8 -*-
"""
Created on Tue Feb 11 17:39:03 2025
...
#%% Results
print('Opt+Setup Time AIL_V3', timeAIL)
print('Optimization Time AIL_V3', timeOAIL)    
...
with open("gurobi_statistics_AILV3.txt", "w") as file:
    file.write("Scenarios,Method,Nodes Explored,Opt Time,Opt+Setup Time,Optimality Gap,Master Obj,Fixed Costs,2-Stage OF,r\n")
    file.write(f"{N},AILV3,{nodes_explored},{timeOAIL},{timeAIL},{gap},{OF},{Fixed_costs},{Second_Stage_OF},{r}\n")
